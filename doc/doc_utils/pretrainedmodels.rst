...
.. list-table:: Available Models
   ...
   * - huggingface-translation-opus-mt-en-es
     ...
     - 2.1.2
     - 2.189.0
     - ProblemTypes.MACHINE_TRANSLATION
   ...
   * - mxnet-is-mask-rcnn-fpn-resnet101-v1d-coco
     ...
     - 2.0.9
     - 2.189.0
     - ProblemTypes.INSTANCE_SEGMENTATION
   ...
   * - mxnet-semseg-fcn-resnet101-ade
     ...
     - 2.0.9
     - 2.189.0
     - ProblemTypes.SEMANTIC_SEGMENTATION
     - `GluonCV <https://cv.gluon.ai/model_zoo/segmentation.html>`__ |external-link|
   ...
   * - pytorch-ic-alexnet
     ...
     - 3.1.1
     - 2.189.0
     - ProblemTypes.IMAGE_CLASSIFICATION
...
.. list-table:: Available Proprietary Models
   ...
   * - arcee-nova
     ...
     - v1
     - 2.213.0
     - `Source <https://aws.amazon.com/marketplace/pp/prodview-ngf4ezem6q7eo>`__ |external-link|
   * - arcee-supernova
     - False
     - v2
     - 2.213.0
