...
from sagemaker.core.remote_function.client import *  # noqa: F401, F403

warnings.warn(
    "sagemaker.train.remote_function.client has been moved to sagemaker.core.remote_function.client. "
