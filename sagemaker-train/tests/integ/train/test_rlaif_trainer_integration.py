...
def test_rlaif_trainer_lora_complete_workflow(sagemaker_session):
    ...
    logger.info("=== START test_rlaif_trainer_lora_complete_workflow ===")
    ...
    try:
        ...
        logger.info(f"RLAIFTrainer created: model={rlaif_trainer.model}, training_type={rlaif_trainer.training_type}")

        # Create training job
        logger.info("Calling rlaif_trainer.train(wait=False)...")
        ...
        logger.error(f"test_rlaif_trainer_lora_complete_workflow FAILED: {type(e).__name__}: {e}")
        logger.error(traceback.format_exc())
        raise
    logger.info("=== END test_rlaif_trainer_lora_complete_workflow - PASSED ===")
...
def test_rlaif_trainer_with_custom_reward_settings(sagemaker_session):
    ...
    logger.info("=== START test_rlaif_trainer_with_custom_reward_settings ===")
    logger.info(f"sagemaker_session region: {sagemaker_session.boto_region_name}")
    ...
    try:
        ...
        logger.info(f"RLAIFTrainer created with custom reward prompt ARN")
        ...
        logger.error(f"test_rlaif_trainer_with_custom_reward_settings FAILED: {type(e).__name__}: {e}")
        logger.error(traceback.format_exc())
        raise
    logger.info("=== END test_rlaif_trainer_with_custom_reward_settings - PASSED ===")


def test_rlaif_trainer_continued_finetuning(sagemaker_session):
    """Test complete RLAIF training workflow with LORA."""
    logger.info("=== START test_rlaif_trainer_continued_finetuning ===")
    logger.info(f"sagemaker_session region: {sagemaker_session.boto_region_name}")
    ...
    try:
        ...
        logger.info(f"RLAIFTrainer created for continued finetuning from model-package ARN")
        ...
        logger.error(f"test_rlaif_trainer_continued_finetuning FAILED: {type(e).__name__}: {e}")
        logger.error(traceback.format_exc())
        raise
    logger.info("=== END test_rlaif_trainer_continued_finetuning - PASSED ===")
