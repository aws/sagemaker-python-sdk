...
class TestHyperparameterTunerWarmStart:
    ...
    def test_transfer_learning_tuner_with_new_trainer(
        ...
        new_trainer.training_image = (
            "123456789.dkr.ecr.us-west-2.amazonaws.com/sagemaker-training:latest"
        )
...
class TestHyperparameterTunerPrepare:
    ...
    def test_prepare_auto_parameters_for_tuning_enabled(self, mock_model_trainer):
