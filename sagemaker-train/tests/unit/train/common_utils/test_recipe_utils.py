...
class TestGetHubContentMetadata:
    ...
    def test_get_metadata_success(self, mock_hub_content_class):
        ...
        result = _get_hub_content_metadata(
            hub_name="SageMakerPublicHub", hub_content_name="test-model"
        )
...
class TestDownloadS3Json:
    ...
    def test_download_success(self, mock_boto_client):
        ...
        s3_mock.get_object.return_value = {"Body": BytesIO(json.dumps(test_data).encode("utf-8"))}

        result = _download_s3_json("s3://test-bucket/path/to/file.json")

        assert result == test_data
        s3_mock.get_object.assert_called_once_with(Bucket="test-bucket", Key="path/to/file.json")
    ...
    def test_download_with_region(self, mock_boto_client):
        ...
        s3_mock.get_object.return_value = {"Body": BytesIO(b'{"test": true}')}
    ...
    def test_download_invalid_json(self, mock_boto_client):
        ...
        s3_mock.get_object.return_value = {"Body": BytesIO(b"invalid json")}
...
class TestFindEvaluationRecipe:
    ...
    def test_find_evaluation_recipe_with_type_filter(self):
        ...
        recipe_collection = [
            {"Type": "Evaluation", "EvaluationType": "LLMAsJudge", "Name": "llmaj-recipe"},
            {
                "Type": "Evaluation",
        ...
        result = _find_evaluation_recipe(
            recipe_collection, evaluation_type="DeterministicEvaluation"
        )
...
class TestGetEvaluationOverrideParams:
    ...
    def test_get_override_params_no_recipes(self, mock_get_metadata):
        ...
        mock_get_metadata.return_value = {"hub_content_document": {"RecipeCollection": []}}
    ...
    def test_get_override_params_no_evaluation_recipe(self, mock_get_metadata):
        ...
        mock_get_metadata.return_value = {
            "hub_content_document": {
                "RecipeCollection": [{"Type": "Training", "Name": "train-recipe"}]
            }
        }
    ...
    def test_get_override_params_with_custom_hub(self, mock_get_metadata, mock_download):
        ...
        _get_evaluation_override_params("test-model", hub_name="CustomHub")
...
class TestExtractEvalOverrideOptions:
    ...
    def test_extract_full_spec(self):
        ...
        result = _extract_eval_override_options(override_params, return_full_spec=True)
    ...
    def test_extract_custom_param_names(self):
        ...
        result = _extract_eval_override_options(
            override_params, param_names=["max_new_tokens", "custom_param"]
        )
    ...
    def test_extract_missing_params(self):
        ...
        override_params = {"max_new_tokens": {"default": 8192}}

        result = _extract_eval_override_options(
            override_params, param_names=["max_new_tokens", "missing_param"]
        )
    ...
    def test_extract_param_without_default(self):
        ...
        override_params = {"max_new_tokens": {"default": 8192}, "no_default": {"type": "integer"}}
