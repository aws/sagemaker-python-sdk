...
class TestMLflowMetricsUtil:
    ...
    def test_init_experiment_not_found(self):
        ...
        with (
            ...
            assert _ErrorConstants.EXPERIMENT_NOT_FOUND.format("nonexistent_experiment") in str(
                exc_info.value
            )
    ...
    def test_list_runs_success(self):
        ...
        with (
            ...
            mock_search.assert_called_once_with(experiment_ids=["exp123"], filter_string=None)
    ...
    def test_list_runs_with_filter(self):
        ...
        with (
            ...
            mock_search.assert_called_once_with(
                experiment_ids=["exp123"], filter_string=expected_filter
            )
    ...
    def test_get_all_metrics_empty_run_id(self):
        ...
        with patch("mlflow.set_tracking_uri"), patch("mlflow.get_experiment_by_name"):
        ...
        with patch("mlflow.set_tracking_uri"), patch("mlflow.get_experiment_by_name"):
            ...
            mock_loss_metrics = {
                "run123": [
                    {
                        "metric_name": "total_loss",
                        "history": [{"step": 1, "value": 0.5}, {"step": 2, "value": 0.3}],
                    }
                ]
            }
    ...
    def test_error_handling_in_methods(self):
        ...
        with patch("mlflow.set_tracking_uri"), patch("mlflow.get_experiment_by_name"):
            ...
            with patch.object(util, "_get_run_ids", side_effect=Exception("Test error")):
                ...
                assert _ErrorConstants.LOSS_METRICS_ERROR.format("Test error") in str(
                    exc_info.value
                )
