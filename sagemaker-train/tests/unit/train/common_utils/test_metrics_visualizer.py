...
class TestGetConsoleJobUrl:
    def test_training_job(self):
        ...
        assert (
            url
            == "https://us-west-2.console.aws.amazon.com/sagemaker/home?region=us-west-2#/jobs/my-job"
        )
    ...
    def test_unknown_job_type_returns_empty(self):
        ...
        assert (
            get_console_job_url("arn:aws:sagemaker:us-west-2:123456789012:unknown-job/my-job") == ""
        )
...
class TestGetAvailableMetrics:
    ...
    def test_returns_metric_names(self, mock_set_uri, mock_get_run):
        ...
        mock_job.mlflow_config.mlflow_resource_arn = (
            "arn:aws:sagemaker:us-west-2:123:mlflow-tracking/abc"
        )
