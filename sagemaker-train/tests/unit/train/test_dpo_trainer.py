...
class TestDPOTrainer:
    ...
    @patch("sagemaker.train.dpo_trainer._create_model_package_config")
    @patch("sagemaker.core.resources.TrainingJob.create")
    def test_train_with_full_training(
        self,
        mock_training_job_create,
        mock_model_package_config,
        mock_mlflow_config,
    ...
    def test_model_package_group_handling(
        self, mock_validate_group, mock_get_options, mock_resolve_model
    ):
        mock_validate_group.return_value = "test-group"
...
class TestDPOTrainerListSupportedModels:
    ...
    def test_list_supported_models(self, mock_list):
        ...
        mock_list.assert_called_once_with(recipe_type="FineTuning", technique="DPO", session=None)
