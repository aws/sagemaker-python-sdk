...
class TestBaseEvaluatorInit:
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_init_with_model_package_arn(
        self, mock_resolve, mock_session, mock_model_info_with_package
    ):
    ...
    @patch("boto3.Session")
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_init_without_session_creates_default(
        self, mock_resolve, mock_boto_session_cls, mock_model_info
    ):
    ...
    @patch("boto3.Session")
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_init_respects_region_env_var(
        self, mock_resolve, mock_boto_session_cls, mock_env_get, mock_model_info
    ):
        """Test that SAGEMAKER_REGION environment variable is respected."""
        mock_resolve.return_value = mock_model_info
        mock_env_get.side_effect = lambda key, default=None: (
            "eu-west-1" if key == "SAGEMAKER_REGION" else None
        )
        mock_boto_session = MagicMock()
    ...
    @patch("boto3.Session")
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_init_creates_session_without_endpoint(
        self, mock_resolve, mock_boto_session_cls, mock_model_info
    ):
...
class TestMLFlowARNValidation:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "arn:aws-us-gov:sagemaker:us-gov-west-1:123456789012:mlflow-tracking-server/my-server",
                True,
            ),
            (
                "arn:aws:sagemaker:eu-west-1:123456789012:mlflow-tracking-server/server-name-123",
                True,
            ),
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_mlflow_arn_validation(
        self, mock_resolve, mlflow_arn, should_pass, mock_session, mock_model_info
    ):
    ...
    def test_mlflow_arn_optional_with_resolution(
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    @patch("sagemaker.train.evaluate.base_evaluator._resolve_mlflow_resource_arn")
    def test_mlflow_arn_provided_skips_resolution(
        self, mock_resolve_mlflow, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    @patch("sagemaker.train.evaluate.base_evaluator._resolve_mlflow_resource_arn")
    def test_mlflow_arn_resolution_returns_none(
        self, mock_resolve_mlflow, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    @patch("sagemaker.train.evaluate.base_evaluator._resolve_mlflow_resource_arn")
    def test_mlflow_arn_resolution_with_exception(
        self, mock_resolve_mlflow, mock_resolve, mock_session, mock_model_info
    ):
...
class TestModelPackageGroupValidation:
    ...
    def test_model_package_group_name_resolution(
        self, mock_mpg_get, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_model_package_group_object_resolution(
        self, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    @patch("sagemaker.core.resources.ModelPackageGroup.get")
    def test_model_package_group_name_not_found(
        self, mock_mpg_get, mock_resolve, mock_session, mock_model_info
    ):
...
class TestModelResolution:
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_model_resolution_model_package(
        self, mock_resolve, mock_session, mock_model_info_with_package
    ):
...
class TestModelPackageGroupInference:
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_infer_model_package_group_arn(
        self, mock_resolve, mock_session, mock_model_info_with_package
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_infer_model_package_group_arn_no_source(
        self, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_model_package_group_arn_provided(
        self, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_model_package_group_arn_inferred(
        self, mock_resolve, mock_session, mock_model_info_with_package
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_model_package_group_arn_missing_returns_none(
        self, mock_resolve, mock_session, mock_model_info
    ):
...
class TestArtifactManagement:
    ...
    def test_get_existing_artifact(self, mock_get_all, mock_resolve, mock_session, mock_model_info):
        ...
        artifact_arn = evaluator._get_or_create_artifact_arn(
            DEFAULT_HUB_CONTENT_ARN, DEFAULT_REGION
        )
    ...
    def test_create_new_artifact_for_hub_content(
        self, mock_create, mock_get_all, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.core.resources.Artifact.get_all")
    @patch("sagemaker.core.resources.Artifact.create")
    def test_create_new_artifact_for_model_package(
        self, mock_create, mock_get_all, mock_resolve, mock_session, mock_model_info_with_package
    ):
        ...
        artifact_arn = evaluator._get_or_create_artifact_arn(
            DEFAULT_MODEL_PACKAGE_ARN, DEFAULT_REGION
        )
        assert artifact_arn == DEFAULT_ARTIFACT_ARN
        mock_create.assert_called_once()
    ...
    @patch("sagemaker.core.resources.Artifact.get_all")
    @patch("sagemaker.core.resources.Artifact.create")
    def test_artifact_creation_failure(
        self, mock_create, mock_get_all, mock_resolve, mock_session, mock_model_info
    ):
...
class TestAWSExecutionContext:
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_aws_execution_context(
        self, mock_resolve, mock_role, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.evaluate.base_evaluator.resolve_and_validate_role")
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_aws_execution_context_with_explicit_role(
        self, mock_resolve, mock_role, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.evaluate.base_evaluator.resolve_and_validate_role")
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_aws_execution_context_without_region(
        self, mock_resolve, mock_role, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.evaluate.base_evaluator.resolve_and_validate_role")
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_aws_execution_context_role_type_override(
        self, mock_resolve, mock_role, mock_session, mock_model_info
    ):
...
class TestTemplateRendering:
    ...
    def test_add_vpc_and_kms_to_context(self, mock_resolve, mock_session, mock_model_info):
        ...
        vpc_config = VpcConfig(
            security_group_ids=["sg-12345"], subnets=["subnet-12345", "subnet-67890"]
        )
...
class TestResolveModelArtifacts:
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    @patch("sagemaker.core.resources.Artifact.get_all")
    def test_resolve_model_artifacts_jumpstart(
        self, mock_get_all, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    @patch("sagemaker.core.resources.Artifact.get_all")
    def test_resolve_model_artifacts_model_package(
        self, mock_get_all, mock_resolve, mock_session, mock_model_info_with_package
    ):
...
class TestDatasetValidation:
    ...
    def test_validate_dataset_hub_content_arn_valid(self):
        ...
        dataset_arn = (
            "arn:aws:sagemaker:us-east-1:123456789012:hub-content/AIRegistry/DataSet/my-dataset/1.0"
        )
    ...
    def test_validate_dataset_hub_content_arn_cn_partition(self):
        ...
        dataset_arn = (
            "arn:aws-cn:sagemaker:cn-north-1:123456789012:hub-content/CustomHub/DataSet/dataset/2.0"
        )
        result = BaseEvaluator._validate_and_resolve_dataset(dataset_arn)
        assert result == dataset_arn
...
class TestModelPackageGroupRefactored:
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_mpg_arn_user_provided_for_jumpstart(
        self, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_mpg_arn_user_provided_for_model_package(
        self, mock_resolve, mock_session, mock_model_info_with_package
    ):
        ...
        user_provided_arn = (
            "arn:aws:sagemaker:us-west-2:123456789012:model-package-group/user-provided"
        )
        evaluator = BaseEvaluator(
            model=DEFAULT_MODEL_PACKAGE_ARN,
            s3_output_path=DEFAULT_S3_OUTPUT,
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_mpg_arn_inferred_for_model_package(
        self, mock_resolve, mock_session, mock_model_info_with_package
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_mpg_arn_returns_none_for_jumpstart(
        self, mock_resolve, mock_session, mock_model_info
    ):
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_get_mpg_arn_fails_for_model_package_inference_failure(
        self, mock_resolve, mock_session
    ):
...
class TestEdgeCases:
    ...
    @patch("sagemaker.train.common_utils.model_resolution._resolve_base_model")
    def test_invalid_model_package_arn_format(
        self, mock_resolve, mock_session, mock_model_info_with_package
    ):
    ...
    def test_with_all_optional_params(self, mock_resolve, mock_session, mock_model_info):
        ...
        vpc_config = VpcConfig(security_group_ids=["sg-12345"], subnets=["subnet-12345"])
...
class TestApplyEvalRecipeValues:
    ...
    def test_skips_none_values(self):
        ...
        applied = BaseEvaluator._apply_eval_recipe_values(recipe, {"model_name_or_path": None})
...
class TestApplyEvalRecipeValuesPlaceholders:
    ...
    def test_resolves_placeholder_token_differing_from_leaf_key(self):
        ...
        applied = BaseEvaluator._apply_eval_recipe_values(recipe, {"evaluation_metric": "all"})
    ...
    def test_quoted_placeholder_token(self):
        ...
        BaseEvaluator._apply_eval_recipe_values(recipe, {"model_name_or_path": "org/model"})
...
class TestBuildEvalValueMap:
    ...
    def test_semantic_values_override_spec_defaults(self):
        ...
        value_map = BaseEvaluator._build_eval_value_map(spec, semantic_values={"task": "mmlu"})
...
class TestEvalValueMapTypeCoercion:
    ...
    def test_stringified_float_coerced(self):
        ...
        value_map = BaseEvaluator._build_eval_value_map(spec, semantic_values={"top_p": "1.0"})
    ...
    def test_integer_type_accepts_float_like_string(self):
        ...
        value_map = BaseEvaluator._build_eval_value_map(spec, semantic_values={"top_k": "-1"})
    ...
    def test_string_type_left_as_string(self):
        ...
        value_map = BaseEvaluator._build_eval_value_map(spec, semantic_values={"task": "gen_qa"})
