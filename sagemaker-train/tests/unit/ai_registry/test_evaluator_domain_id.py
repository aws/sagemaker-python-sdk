...
class TestEvaluatorDomainId:
    ...
    def test_domain_id_added_when_available(self, mock_air_hub, mock_get_domain_id):
        ...
        mock_air_hub.describe_hub_content = Mock(
            return_value={
    ...
    @patch("sagemaker.ai_registry.evaluator._get_current_domain_id")
    @patch("sagemaker.ai_registry.evaluator.AIRHub")
    def test_domain_id_not_added_when_unavailable(self, mock_air_hub, mock_get_domain_id):
    ...
    @patch("sagemaker.ai_registry.evaluator._get_current_domain_id")
    @patch("sagemaker.ai_registry.evaluator.AIRHub")
    def test_explicit_domain_id_used_without_auto_detection(self, mock_air_hub, mock_get_domain_id):
