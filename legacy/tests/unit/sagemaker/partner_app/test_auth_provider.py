...
from sagemaker.partner_app.auth_provider import RequestsAuth, PartnerAppAuthProvider


class TestRequestsAuth(unittest.TestCase):

    @patch("sagemaker.partner_app.auth_provider.PartnerAppAuthUtils.get_signed_request")
    @patch("sagemaker.partner_app.auth_provider.SigV4Auth")
...
class TestPartnerAppAuthProvider(unittest.TestCase):
    ...
    @patch("sagemaker.partner_app.auth_provider.boto3.Session")
    @patch("sagemaker.partner_app.auth_provider.SigV4Auth")
    @patch("sagemaker.partner_app.auth_provider.PartnerAppAuthUtils.get_signed_request")
