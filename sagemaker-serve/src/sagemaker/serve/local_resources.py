...
These classes provide sagemaker-core compatible interfaces for local deployment, wrapping V2 local
mode functionality.
"""
...
class LocalEndpoint:
    ...
    This class wraps V2 LocalSession endpoint functionality to provide a unified interface
    compatible with sagemaker-core Endpoint resources.
    """
        ...
        **kwargs,
        ...
        if self.in_process_mode:
            ...
            return InvokeEndpointOutput(
                body=deserializer.deserialize(io.BytesIO(raw_response)), content_type=accept
            )
            ...
            content_type = (
                content_type if content_type != "application/json" else serializer.CONTENT_TYPE
            )
            ...
            if self.model_server == ModelServer.TORCHSERVE:
                ...
                raw_response = self.local_container_mode_obj._invoke_triton_server(
                    body, APPLICATION_X_NPY, APPLICATION_X_NPY  # ← Direct data, no serialization
                )
                ...
                response_data = deserializer.deserialize(io.BytesIO(raw_response), content_type)
            ...
            return InvokeEndpointOutput(
                body=io.BytesIO(json.dumps(response_data).encode("utf-8")), content_type=accept
            )
    ...
    def create(
        ...
        **kwargs,
        ...
        if in_process_mode:
            ...
            endpoint.in_process_mode_obj.create_server(ping_fn=endpoint._universal_deep_ping)
            ...
            local_session.sagemaker_client.create_endpoint(
                EndpointName=endpoint_name, EndpointConfigName=endpoint.endpoint_config_name
            )
    ...
    def delete(self) -> None:
        ...
        """
        self._local_session.sagemaker_client.delete_endpoint(EndpointName=self.endpoint_name)
...
class LocalEndpointConfig:
    ...
    def __init__(
        self, endpoint_config_name: str, production_variants: list, local_session=None, **kwargs
    ):
