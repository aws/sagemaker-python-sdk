...
"""Backward compatibility shim for async_inference_config.
...
warnings.warn(
    "Importing from sagemaker.serve.async_inference.async_inference_config is deprecated. "
    "The AsyncInferenceConfig class has been moved to sagemaker.core.inference_config. "
