...
import sagemaker
from sagemaker import fw_utils, git_utils, local, s3, session, utils
from sagemaker.async_inference import AsyncInferenceConfig
from sagemaker.compute_resource_requirements.resource_requirements import \
    ResourceRequirements
from sagemaker.config import (COMPILATION_JOB_ROLE_ARN_PATH,
                              ...
                              MODEL_VPC_CONFIG_PATH, load_sagemaker_config)
...
from sagemaker.jumpstart.utils import (
    add_jumpstart_uri_tags, get_jumpstart_base_name_if_jumpstart_model)
from sagemaker.metadata_properties import MetadataProperties
from sagemaker.model_card import ModelCard, ModelPackageModelCard
...
from sagemaker.utils import (Tags, _resolve_routing_config, _validate_new_tags,
                             ...
                             resolve_value_from_config, to_string,
...
class _Model(ModelBase, InferenceRecommenderMixin):
    ...
    @runnable_by_pipeline
    # TODO: call in sagemaker core ModelPackage.create()
    def register(
        self,
    ...
    @runnable_by_pipeline
    # TODO: iteration, call this in ModelBuilder.build()
    def create(
        self,
...
api/latest/reference/services/sagemaker.html#SageMaker.Client.add_tags>`_
    ...
    # TODO: iteration, ModelBuilder.prepare_container_def()
    ...
    # TODO: iteration, use Network in ModelBuilder
    ...
    def _ensure_base_name_if_needed(self, image_uri, script_uri, model_uri):
        ...
        if self.name is None:
            self._base_name = (
                ...
                or utils.base_name_from_image(image_uri, default_base_name=_Model.__name__)
            )
    ...
    # TODO: iteration, eventually use SagemakerCore EdgePackaingJob.create()
    ...
    # TODO: iteration, move to modelbuilder.deploy() after build is done
    def deploy(
        self,
    ...
    # TODO: call in ModelBuilder.transform then eventually migrate this functionality to ModelBuilder.transform
    def transformer(
        self,
        instance_count,
        instance_type,
    ...
    # TODO: keep same as V2, maybe move this to MB
