...
class TestPhase(unittest.TestCase):
    ...
    def test_phase_initialization(self):
        ...
        phase = Phase(duration_in_seconds=300, initial_number_of_users=1, spawn_rate=2)
...
class TestInferenceRecommenderMixin(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mixin.image_uri = (
            "123456789012.dkr.ecr.us-west-2.amazonaws.com/pytorch-inference:1.9.0-cpu-py38"
        )
    ...
    def test_convert_to_stopping_conditions_json_max_invocations(self):
        ...
        result = self.mixin._convert_to_stopping_conditions_json(
            max_invocations=1000, model_latency_thresholds=None
        )
    ...
    def test_search_recommendation_not_found(self):
        ...
        recommendations = [{"RecommendationId": "rec-1", "InstanceType": "ml.m5.large"}]
    ...
    def test_filter_recommendations_for_realtime(self):
        ...
        self.mixin.inference_recommendations = [
            {"EndpointConfiguration": {"ServerlessConfig": {"MemorySizeInMB": 2048}}},
            {"EndpointConfiguration": {"InstanceType": "ml.m5.large", "InitialInstanceCount": 2}},
        ]
    ...
    def test_update_params_returns_provided_params(self):
        ...
        result = self.mixin._update_params(instance_type="ml.m5.large", initial_instance_count=2)
    ...
    def test_framework_mapping_constants(self):
        ...
        self.assertEqual(
            INFERENCE_RECOMMENDER_FRAMEWORK_MAPPING["sklearn"], "SAGEMAKER-SCIKIT-LEARN"
        )
