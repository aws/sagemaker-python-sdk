...
class TestCastToCompatibleVersion(unittest.TestCase):
    ...
    def test_cast_exact_match(self, mock_config):
        ...
        mock_config.return_value = {"versions": {"1.9.0": {}, "1.9.1": {}, "1.10.0": {}}}
    ...
    def test_cast_with_upcast(self, mock_config):
        ...
        mock_config.return_value = {"versions": {"1.9.0": {}, "1.10.0": {}, "1.11.0": {}}}
    ...
    def test_cast_with_post_version(self, mock_config):
        ...
        mock_config.return_value = {"versions": {"1.9.0": {}, "1.9.0.post1": {}, "1.10.0": {}}}
...
class TestAutoDetectContainer(unittest.TestCase):
    ...
    def test_auto_detect_pytorch_success(
        self, mock_py_tuple, mock_retrieve, mock_cast, mock_detect, mock_base
    ):
    ...
    @patch("sagemaker.serve.detector.image_detector.image_uris.retrieve")
    @patch("sagemaker.serve.detector.image_detector.platform.python_version_tuple")
    def test_auto_detect_sklearn_uses_py3(
        self, mock_py_tuple, mock_retrieve, mock_cast, mock_detect, mock_base
    ):
    ...
    @patch("sagemaker.serve.detector.image_detector.image_uris.retrieve")
    @patch("sagemaker.serve.detector.image_detector.platform.python_version_tuple")
    def test_auto_detect_fallback_to_latest(
        self, mock_py_tuple, mock_retrieve, mock_cast, mock_detect, mock_base
    ):
        ...
        with patch(
            "sagemaker.serve.detector.image_detector.image_uris._config_for_framework_and_scope"
        ) as mock_config:
            mock_config.return_value = {"versions": {"1.8.0": {}, "1.9.0": {}, "1.10.0": {}}}
    ...
    @patch("sagemaker.serve.detector.image_detector.image_uris.retrieve")
    @patch("sagemaker.serve.detector.image_detector.platform.python_version_tuple")
    def test_auto_detect_no_compatible_version(
        self, mock_py_tuple, mock_retrieve, mock_cast, mock_detect, mock_base
    ):
