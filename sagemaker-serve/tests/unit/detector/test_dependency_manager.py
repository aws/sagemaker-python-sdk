...
class TestParseDependencyList:
    ...
    def test_parse_with_version_constraints(self):
        dependencies = ["numpy>=1.20.0", "pandas==1.3.0", "scikit-learn<1.0.0", "torch<=1.9.0"]
        result = _parse_dependency_list(dependencies)
    ...
    def test_parse_with_multiple_constraints(self):
        dependencies = ["package>=1.0.0,<2.0.0", "another>=0.5,<=1.5"]
        result = _parse_dependency_list(dependencies)
    ...
    def test_parse_with_url(self):
        dependencies = ["package@https://github.com/user/repo/archive/main.zip"]
        result = _parse_dependency_list(dependencies)
    ...
    def test_parse_with_comments(self):
        dependencies = ["# This is a comment", "numpy>=1.20.0", "# Another comment", "pandas"]
        result = _parse_dependency_list(dependencies)
    ...
    def test_parse_with_dots_and_dashes(self):
        dependencies = ["my-package.name>=1.0", "another_package==2.0"]
        result = _parse_dependency_list(dependencies)
