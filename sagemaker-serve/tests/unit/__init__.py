...
from sagemaker.core.config.config_schema import (ASYNC_INFERENCE_CONFIG,
                              ...
                              COMPILATION_JOB, CONTAINERS, DATA_CAPTURE_CONFIG,
                              DATASET_DEFINITION, DEBUG_HOOK_CONFIG,
                              DEFAULT_S3_BUCKET, DEFAULT_S3_OBJECT_KEY_PREFIX,
                              DISABLE_PROFILER, EDGE_PACKAGING_JOB,
                              ENABLE_INTER_CONTAINER_TRAFFIC_ENCRYPTION,
                              ENABLE_NETWORK_ISOLATION, ENDPOINT,
                              ENDPOINT_CONFIG, ENVIRONMENT, ESTIMATOR,
                              EXECUTION_ROLE_ARN, FEATURE_GROUP,
                              INFERENCE_SPECIFICATION, KEY, KMS_KEY_ID, MODEL,
                              MODEL_PACKAGE, MODULES,
                              MONITORING_JOB_DEFINITION,
                              MONITORING_OUTPUT_CONFIG, MONITORING_RESOURCES,
                              MONITORING_SCHEDULE, MONITORING_SCHEDULE_CONFIG,
                              NETWORK_CONFIG, OFFLINE_STORE_CONFIG,
                              ONLINE_STORE_CONFIG, OUTPUT_CONFIG,
                              OUTPUT_DATA_CONFIG, PRIMARY_CONTAINER,
                              PROCESSING_INPUTS, PROCESSING_JOB,
                              PROCESSING_OUTPUT_CONFIG, PROCESSING_RESOURCES,
                              PRODUCTION_VARIANTS, PROFILER_CONFIG, PYTHON_SDK,
                              REDSHIFT_DATASET_DEFINITION, RESOURCE_CONFIG,
                              RESOURCE_KEY, ROLE_ARN, S3_STORAGE_CONFIG,
                              SAGEMAKER, SCHEMA_VERSION, SECURITY_CONFIG,
                              SECURITY_GROUP_IDS, SESSION, SUBNETS, TAGS,
                              TRAINING_JOB, TRANSFORM_JOB,
                              TRANSFORM_JOB_DEFINITION, TRANSFORM_OUTPUT,
                              TRANSFORM_RESOURCES, VALIDATION_PROFILES,
                              VALIDATION_ROLE, VALIDATION_SPECIFICATION, VALUE,
                              VOLUME_KMS_KEY_ID, VPC_CONFIG)
