...
class TestInferenceConfigParameterHandling(unittest.TestCase):
    ...
    def test_inference_config_provided_all_fields(
        ...
        mock_ic = Mock()
        mock_ic.inference_component_arn = "arn:aws:sagemaker:us-west-2:123456789012:inference-component/test"
        mock_ic_get.return_value = mock_ic
        
        # Setup: Mock lineage tracking
        mock_fetch_package_arn.return_value = "arn:aws:sagemaker:us-west-2:123456789012:model-package/test"
        mock_artifact = Mock()
    ...
    def test_all_resource_requirements_fields_reach_api_call(
        ...
        assert compute_reqs.number_of_cpu_cores_required == 12, \
            "number_of_cpu_cores_required should be 12"
        assert compute_reqs.min_memory_required_in_mb == 24576, \
            "min_memory_required_in_mb should be 24576"
        assert compute_reqs.max_memory_required_in_mb == 49152, \
