...
class TestMultiModelServerInference(unittest.TestCase):
    ...
    def test_input_fn_with_preprocess_logic(self):
        ...
        result = input_fn(
            '{"data": [1, 2, 3]}', ["application/json"], schema_builder, inference_spec
        )
    ...
    def test_input_fn_with_bytes_input_logic(self):
        ...
        result = input_fn(
            b'{"data": [1, 2, 3]}', ["application/json"], schema_builder, inference_spec
        )
    ...
    def test_output_fn_with_postprocess_logic(self):
        ...
        schema_builder.custom_output_translator.serialize = Mock(
            return_value=b'{"predictions": [0.1, 0.9]}'
        )
        ...
        schema_builder.custom_output_translator.serialize.assert_called_once_with(
            {"postprocessed": True}, "application/json"
        )
