...
class TestTorchServePrepare(unittest.TestCase):
    ...
    @patch("shutil.copy2")
    def test_prepare_for_torchserve_standard_image(
        self, mock_copy, mock_is_1p, mock_capture, mock_hash
    ):
    ...
    @patch("sagemaker.serve.model_server.torchserve.prepare.is_1p_image_uri")
    @patch("shutil.copy2")
    def test_prepare_for_torchserve_xgboost_image(
        self, mock_copy, mock_is_1p, mock_capture, mock_hash, mock_rename
    ):
    ...
    @patch("sagemaker.serve.model_server.torchserve.prepare.is_1p_image_uri")
    @patch("shutil.copy2")
    def test_prepare_for_torchserve_with_shared_libs(
        self, mock_copy, mock_is_1p, mock_capture, mock_hash
    ):
    ...
    @patch("sagemaker.serve.model_server.torchserve.prepare.is_1p_image_uri")
    @patch("shutil.copy2")
    def test_prepare_for_torchserve_no_inference_spec(
        self, mock_copy, mock_is_1p, mock_capture, mock_hash
    ):
