...
class TestTgiPrepare(unittest.TestCase):
    ...
    def test_copy_jumpstart_artifacts_with_tarball(
        ...
        result = _copy_jumpstart_artifacts(
            model_data="s3://bucket/model.tar.gz", js_id="test-id", code_dir=code_dir
        )
    ...
    def test_copy_jumpstart_artifacts_uncompressed(self, mock_s3_downloader):
        ...
        result = _copy_jumpstart_artifacts(
            model_data="s3://bucket/model/", js_id="test-id", code_dir=code_dir
        )
    ...
    def test_copy_jumpstart_artifacts_with_dict(self, mock_s3_downloader):
        ...
        model_data = {"S3DataSource": {"S3Uri": "s3://bucket/model/"}}

        result = _copy_jumpstart_artifacts(
            model_data=model_data, js_id="test-id", code_dir=code_dir
        )
    ...
    def test_copy_jumpstart_artifacts_invalid_format(self, mock_s3_downloader):
        ...
        with self.assertRaises(ValueError):
            _copy_jumpstart_artifacts(
                model_data={"invalid": "format"}, js_id="test-id", code_dir=code_dir
            )
