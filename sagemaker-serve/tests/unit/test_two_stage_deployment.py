...
class TestTwoStageDeployment:
    ...
    def test_base_model_deployment_tagged_correctly(
        ...
        mock_package = Mock()
        mock_package.model_package_arn = "arn:aws:sagemaker:us-west-2:123456789012:model-package/test-package"
        mock_container = Mock()
        ...
        mock_ic = Mock()
        mock_ic.inference_component_arn = "arn:aws:sagemaker:us-west-2:123456789012:inference-component/test-ic"
        ...
        model_builder._cached_compute_requirements = InferenceComponentComputeResourceRequirements(
            min_memory_required_in_mb=24576,
            number_of_accelerator_devices_required=4
        )
        
        # Deploy with mocked lineage tracking
        with patch('sagemaker.core.resources.Action'), \
             patch('sagemaker.core.resources.Association'), \
             patch('sagemaker.core.resources.Artifact'):
            model_builder._deploy_model_customization(
    ...
    def test_lora_adapter_references_base_component(
        ...
        mock_base_ic.inference_component_arn = "arn:aws:sagemaker:us-west-2:123456789012:inference-component/base"
    ...
    def test_base_model_uses_hosting_artifact_uri(
        ...
        mock_fetch_hub.return_value = {
            'HostingArtifactUri': expected_artifact_uri
        }
    ...
    def test_sequential_base_then_adapter_deployment(
        ...
        mock_adapter_package.model_package_arn = "arn:aws:sagemaker:us-west-2:123456789012:model-package/adapter-package"
        ...
        adapter_builder._cached_compute_requirements = InferenceComponentComputeResourceRequirements(
            min_memory_required_in_mb=24576,
            number_of_accelerator_devices_required=4
        )
        
        # Deploy adapter (no lineage tracking for existing endpoint)
        adapter_builder._deploy_model_customization(
            endpoint_name="test-endpoint"
        )
    ...
    def test_routing_with_both_base_and_adapter_components(self):
        ...
        response = mock_endpoint.invoke(
            body={"input": "test"},
            inference_component_name="test-endpoint-base-component"
        )
        ...
        response = mock_endpoint.invoke(
            body={"input": "test"},
            inference_component_name="test-endpoint-adapter-component"
        )
