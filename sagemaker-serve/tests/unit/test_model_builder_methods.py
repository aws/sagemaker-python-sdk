...
class TestModelBuilderSimpleMethods:
    ...
    def test_get_client_translators_with_npy_content_type(self):
        ...
        with patch.object(
            builder, "_fetch_serializer_and_deserializer_for_framework", return_value=(None, None)
        ):
...
class TestBuildForPassthroughLocalContainer:
    ...
    def test_build_for_passthrough_initializes_secret_key(self, mock_prepare, mock_create):
...
class TestPreservationNonPassthroughBehavior:
    ...
    **Validates: Requirements 3.1, 3.2, 3.3, 3.4, 3.5**
    ...
    @patch.object(ModelBuilder, "_create_model")
    @patch.object(ModelBuilder, "_prepare_for_mode")
    def test_build_for_passthrough_sagemaker_endpoint_unchanged(self, mock_prepare, mock_create):
