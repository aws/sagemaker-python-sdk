"""Unit tests for the JumpStart model ID in ModelBuilder telemetry.

The model ID lets usage analytics identify the JumpStart model behind each
...
class TestJumpStartTelemetry(unittest.TestCase):
    """Tests for the x-jumpstartModelId telemetry param."""
    ...
    def test_build_emits_the_model_id_for_a_jumpstart_model(
        ...
        assert "&x-isJumpstartModelId=" not in extra
