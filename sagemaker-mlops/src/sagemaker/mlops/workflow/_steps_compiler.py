...
class CompiledStep(Step):
    ...
    def add_depends_on(self, step_names: List[Union[str, "Step", StepOutput]]):
...
class StepsCompiler(object):
    ...
    def __init__(
        ...
        pipeline_name: str,
        sagemaker_session,
        steps: Sequence[Union[Step, StepOutput]],
        ...
        Args:
            ...
            sagemaker_session (sagemaker.core.helper.session.Session): The session object used for compile the
              steps.
    ...
    def _simplify_step_list(
        self,
        step_list: List[Union[str, Step, StepOutput]],
    ) -> List[Step]:
        """Simplify an input step list containing strings, StepOutput."""
    ...
    def _initialize_queue_and_build(self, steps: List[Union[Step, StepOutput]]):
        """Build a list of steps."""
