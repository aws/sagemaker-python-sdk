...
class PipelineExperimentConfig(Entity):
    ...
    def __init__(
        self,
        experiment_name: Union[str, Parameter, ExecutionVariable, PipelineVariable],
        trial_name: Union[str, Parameter, ExecutionVariable, PipelineVariable],
    ):
...
class PipelineExperimentConfigProperty(PipelineVariable):
