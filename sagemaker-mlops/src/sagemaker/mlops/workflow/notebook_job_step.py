...
from sagemaker.core.workflow.utilities import _collect_parameters, load_step_compilation_context
from sagemaker.core.helper.session_helper import get_execution_role, expand_role
...
class NotebookJobStep(ConfigurableRetryStep):
    ...
    def __init__(
        ...
        depends_on: Optional[List[Union[Step, StepOutput]]] = None,
    ):
        ...
        Args:
            ...
            depends_on (List[Union[Step, StepOutput]]): A list of `Step`/
                `StepOutput` instances on which this `NotebookJobStep` depends.
        """
    ...
    def depends_on(self, depends_on: List[Union[str, "Step", StepOutput]]):
