...
from sagemaker.mlops.feature_store.feature_processor._input_loader import (
...
@patch(
    "sagemaker.mlops.feature_store.feature_processor._input_loader."
...
@patch(
    "sagemaker.mlops.feature_store.feature_processor._input_offset_parser.InputOffsetParser.get_iso_format_offset_date",
    side_effect=[
        "start_time",
        "end_time",
    ],
...
@patch(
    "sagemaker.mlops.feature_store.feature_processor._input_offset_parser.InputOffsetParser."
