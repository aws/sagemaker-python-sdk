...
class ServerlessInferenceConfig(object):
    ...
    def __init__(
        ...
        Args:
            memory_size_in_mb (int): Required. The memory size of your serverless endpoint.
                Valid values are in 1 GB increments: 1024 MB, 2048 MB, 3072 MB, 4096 MB,
                5120 MB, or 6144 MB.
            max_concurrency (int): Required. The maximum number of concurrent invocations
                your serverless endpoint can process.
        """
