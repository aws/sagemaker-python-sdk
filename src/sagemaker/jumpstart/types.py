...
class HubContentDescription(JumpStartDataHolderType):
    ...
    def __init__(self, json_obj: Dict[str, Any]) -> None:
        """Instantiates HubContentDescription object.
    ...
    def to_json(self) -> Dict[str, Any]:
        """Returns json representation of HubContentDescription object."""
        json_obj = {}
        for att in self.__slots__:
            if hasattr(self, att):
                cur_val = getattr(self, att)
...
class HubDescription(JumpStartDataHolderType):
    ...
    def __init__(self, json_obj: Dict[str, Any]) -> None:
        """Instantiates HubDescription object.
