...
class ContentCopier:
    ...
    def _get_copy_configs_for_inference_dependencies(self, model_specs: JumpStartModelSpecs) -> List[CopyContentConfig]:
        ...
        copy_configs.append(CopyContentConfig(
    ...
    def _get_copy_configs_for_training_dependencies(self, model_specs: JumpStartModelSpecs) -> List[CopyContentConfig]:
        copy_configs = []
    ...
    def _get_copy_configs_for_demo_notebook_dependencies(self, model_specs: JumpStartModelSpecs) -> None:
        copy_configs = []
    ...
    def _get_copy_configs_for_markdown_dependencies(self, model_specs: JumpStartModelSpecs) -> None:
        ...
        copy_configs.append(CopyContentConfig(
            src=markdown_s3_reference,
            dst=markdown_s3_reference_dst,
