...
PRIVATE_MODEL_TRAINING_ARTIFACT_TARBALL_S3_SUFFIX = f"{PRIVATE_MODEL_UNCOMPRESSED_TRAINING_ARTIFACT_S3_SUFFIX}model.tar.gz"
PRIVATE_MODEL_TRAINING_SCRIPT_S3_SUFFIX = "train/sourcedir.tar.gz"
PRIVATE_MODEL_UNCOMPRESSED_HOSTING_ARTIFACT_S3_SUFFIX = "host/"
PRIVATE_MODEL_HOSTING_ARTIFACT_S3_TARBALL_SUFFIX = f"{PRIVATE_MODEL_UNCOMPRESSED_HOSTING_ARTIFACT_S3_SUFFIX}model.tar.gz"
