...
class ModelPackageGroup:
    ...
    def create(self, tags: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
        ...
        return self.sagemaker_session.create_model_package_group(self.name, self.description, tags)

    def describe(self) -> Dict[str, Any]:
        """Describe a ModelPackageGroup."""
        return self.sagemaker_session.describe_model_package_group(
            model_package_group_name=self.name,
        )

    def delete(self):
        """Delete a ModelPackageGroup."""
        self.sagemaker_session.delete_model_package_group(model_package_group_name=self.name)
