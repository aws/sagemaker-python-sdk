...
Which is used for Amazon SageMaker Processing Jobs. These jobs let users perform data
pre-processing, post-processing, feature engineering, data validation, and model evaluation,
...
class ProcessingInput(object):
    ...
    def __init__(
        ...
        ``ProcessingInput`` accepts parameters that specify an Amazon S3 input for a
