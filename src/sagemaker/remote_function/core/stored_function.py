...
class StoredFunction:
    ...
    def __init__(self, sagemaker_session, s3_base_uri, s3_kms_key=None):
    ...
    def save(self, func, *args, **kwargs):
        ...
        serialization.serialize_func_to_s3(
            ...
            s3_path_join(self.s3_base_uri, FUNCTION_FOLDER),
            self.s3_kms_key,
        )
        ...
        serialization.serialize_obj_to_s3(
            (args, kwargs),
            self.sagemaker_session,
            s3_path_join(self.s3_base_uri, ARGUMENTS_FOLDER),
            self.s3_kms_key,
        )
    ...
    def load_and_invoke(self) -> None:
        ...
        func = serialization.deserialize_func_from_s3(
            self.sagemaker_session, s3_path_join(self.s3_base_uri, FUNCTION_FOLDER)
        )
        ...
        args, kwargs = serialization.deserialize_obj_from_s3(
            self.sagemaker_session, s3_path_join(self.s3_base_uri, ARGUMENTS_FOLDER)
        )
        ...
        serialization.serialize_obj_to_s3(
            result,
            self.sagemaker_session,
            s3_path_join(self.s3_base_uri, RESULTS_FOLDER),
            self.s3_kms_key,
        )
