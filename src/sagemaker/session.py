...
class Session(object):
    ...
    def upload_data(self, path, bucket=None, key_prefix='data', ExtraArgs=None):
        ...
        Args:
            ...
            ExtraArgs (dict): Extra arguments that may be passed to the upload operation.
        ...
        for local_path, s3_key in files:
            s3.Object(bucket, s3_key).upload_file(local_path, ExtraArgs=ExtraArgs)
