...
class Bytes(_message.Message):
    ...
    content_type: str
    def __init__(
        self, value: _Optional[_Iterable[bytes]] = ..., content_type: _Optional[str] = ...
    ) -> None: ...
...
class Value(_message.Message):
    ...
    def __init__(
        self,
        float32_tensor: _Optional[_Union[Float32Tensor, _Mapping]] = ...,
        float64_tensor: _Optional[_Union[Float64Tensor, _Mapping]] = ...,
        int32_tensor: _Optional[_Union[Int32Tensor, _Mapping]] = ...,
        bytes: _Optional[_Union[Bytes, _Mapping]] = ...,
    ) -> None: ...
...
class Record(_message.Message):
    ...
    def __init__(
        self,
        features: _Optional[_Mapping[str, Value]] = ...,
        label: _Optional[_Mapping[str, Value]] = ...,
        uid: _Optional[str] = ...,
