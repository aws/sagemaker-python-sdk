    ...
    if artifact_for_transformed_model_data:
        ...
        if mlflow_model_artifact:
            _add_association_between_artifacts(
                mlflow_model_path_artifact_arn=mlflow_model_artifact.artifact_arn,  # pylint: disable=E1101, disable=C0301
                autogenerated_model_data_artifact_arn=artifact_for_transformed_model_data.artifact_arn,  # pylint: disable=C0301
                sagemaker_session=sagemaker_session,
            )
        else:
            logger.warning(
