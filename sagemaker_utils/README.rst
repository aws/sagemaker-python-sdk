...
#. `Installing SageMaker Python SDK <#installing-the-sagemaker-python-sdk-utils>`__
#. `Using the SageMaker Python SDK <https://sagemaker.readthedocs.io/en/stable/overview.html>`__


Installing the SageMaker Python SDK Utils
-----------------------------------
...
::
    ...
    cd sagemaker-python-sdk-staging/sagemaker_utils
    pip install .
