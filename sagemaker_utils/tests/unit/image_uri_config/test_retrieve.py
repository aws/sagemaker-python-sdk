...
@patch("sagemaker.utils.image_uris.config_for_framework", return_value=BASE_CONFIG)
...
@patch("sagemaker.utils.image_uris.config_for_framework")
...
# TODO : ENable when workflows are moved
...
@patch("sagemaker.utils.image_uris.config_for_framework")
@patch("sagemaker.utils.image_uris.retrieve")
