...
from sagemaker.utils.config_schema import TELEMETRY_OPT_OUT_PATH
from sagemaker.utils.telemetry.constants import (
    Feature,
    Status,
    Region,
    DEFAULT_AWS_REGION,
)
from sagemaker.utils.user_agent import SDK_VERSION, process_studio_metadata_file
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if sagemaker_session:
                ...
                telemetry_opt_out_flag = config_mgr.resolve_value_from_config(
                    direct_input=None,
