...
try:
    ...
    raise RuntimeError("Please upgrade to coach-0.11.0.  e.g. 388651196716.dkr.ecr.us-west-2.amazonaws.com/sagemaker-tensorflow-rl-beta:1.11.0-coach11-cpu-py3")
