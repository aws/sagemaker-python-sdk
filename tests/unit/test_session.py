...
def sagemaker_session_with_featurestore_runtime_client():
    boto_mock = MagicMock(name="boto_session")
    sagemaker_session = sagemaker.Session(boto_session=boto_mock, sagemaker_featurestore_runtime_client=MagicMock())
...
def test_feature_group_put_record_with_ttl_and_target_stores(sagemaker_session_with_featurestore_runtime_client):
    ...
    assert (sagemaker_session_with_featurestore_runtime_client.sagemaker_featurestore_runtime_client
