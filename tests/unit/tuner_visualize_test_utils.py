...
TRIALS_DF_TRAINING_JOB_NAMES = [
    "random-240712-1545-019-4ac17a84",
    "random-240712-1545-021-fcd64dc1",
]
...
TUNING_RANGES = [
    {"Name": "n-estimators", "MinValue": "1", "MaxValue": "200", "ScalingType": "Auto"},
...
TUNING_JOB_RESULT = {
    ...
    "HyperParameterTuningJobConfig": {
        "Strategy": "Random",
        "HyperParameterTuningJobObjective": {"Type": "Maximize", "MetricName": "valid-f1"},
    },
