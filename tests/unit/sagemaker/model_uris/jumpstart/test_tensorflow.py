...
def test_jumpstart_tensorflow_model_uri(patched_get_model_specs):
    ...
    assert (
        uri == "s3://jumpstart-cache-prod-us-west-2/tensorflow-infer/"
        "infer-tensorflow-ic-bit-m-r101x1-ilsvrc2012-classification-1.tar.gz"
    )
    ...
    assert (
        uri == "s3://jumpstart-cache-prod-us-west-2/tensorflow-training/"
