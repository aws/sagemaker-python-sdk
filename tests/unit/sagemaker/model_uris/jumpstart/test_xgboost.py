...
def test_jumpstart_xgboost_model_uri(patched_get_model_specs):
    ...
    assert (
        uri == "s3://jumpstart-cache-prod-us-west-2/xgboost-infer/"
        "infer-xgboost-classification-model.tar.gz"
    )
    ...
    assert (
        uri == "s3://jumpstart-cache-prod-us-west-2/xgboost-training/"
        "train-xgboost-classification-model.tar.gz"
    )
