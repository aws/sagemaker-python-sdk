...
def test_jumpstart_lightgbm_script_uri(patched_get_model_specs):
    ...
    assert (
        uri == "s3://jumpstart-cache-prod-us-west-2/source-directory-tarballs/lightgbm/"
    ...
    assert (
        uri == "s3://jumpstart-cache-prod-us-west-2/source-directory-tarballs/lightgbm/"
        "transfer_learning/classification/v1.0.0/sourcedir.tar.gz"
    )
