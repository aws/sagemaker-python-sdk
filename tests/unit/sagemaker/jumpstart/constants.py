...
HUB_CONTENT_DOCUMENT_MODEL_CONTENT_TYPE_DICTS = {
    ...
    "meta-textgeneration-llama-2-70b": {
        ...
        "Hyperparameters": [
            {"Name": "epoch", "Type": "int", "Default": 5, "Min": 1, "Max": 1000, "Scope": "algorithm"},
            {"Name": "learning_rate", "Type": "float", "Default": 0.0001, "Min": 1e-08, "Max": 1, "Scope": "algorithm"},
            {
                "Name": "instruction_tuned",
                "Type": "text",
                "Default": "False",
        ...
        "TrainingMetrics": [
            {"Name": "huggingface-textgeneration:eval-loss", "Regex": "eval_epoch_loss=tensor\\(([0-9\\.]+)"},
            {"Name": "huggingface-textgeneration:eval-ppl", "Regex": "eval_ppl=tensor\\(([0-9\\.]+)"},
            {"Name": "huggingface-textgeneration:train-loss", "Regex": "train_epoch_loss=([0-9\\.]+)"},
        ],
    ...
    "huggingface-textembedding-bloom-7b1": {
        ...
        "deploy_kwargs": {"ModelDataDownloadTimeout": 3600, "ContainerStartupHealthCheckTimeout": 3600},
        "SageMakerSdkPredictorSpecifications": {
