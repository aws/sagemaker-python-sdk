...
def test_hub_content_document_from_json_obj():
    region = "us-west-2"
    gemma_model_document = HubModelDocument(HUB_MODEL_DOCUMENT_DICTS["huggingface-llm-gemma-2b-instruct"], region)
    ...
    assert gemma_model_document.hosting_ecr_uri == "763104351884.dkr.ecr.us-west-2.amazonaws.com/huggingface-pytorch-tgi-inference:2.1.1-tgi1.4.2-gpu-py310-cu121-ubuntu22.04"
    ...
    assert gemma_model_document.hosting_artifact_uri == "s3://jumpstart-cache-prod-us-west-2/huggingface-llm/huggingface-llm-gemma-2b-instruct/artifacts/inference/v1.0.0/"
    assert gemma_model_document.hosting_script_uri == "s3://jumpstart-cache-prod-us-west-2/source-directory-tarballs/huggingface/inference/llm/v1.0.1/sourcedir.tar.gz"
    ...
    assert gemma_model_document.hosting_prepacked_artifact_uri == "s3://jumpstart-cache-prod-us-west-2/huggingface-llm/huggingface-llm-gemma-2b-instruct/artifacts/inference-prepack/v1.0.0/"
    ...
    assert gemma_model_document.hosting_eula_uri == "s3://jumpstart-cache-prod-us-west-2/huggingface-llm/fmhMetadata/terms/gemmaTerms.txt"
    assert gemma_model_document.training_ecr_uri == "763104351884.dkr.ecr.us-west-2.amazonaws.com/huggingface-pytorch-training:2.0.0-transformers4.28.1-gpu-py310-cu118-ubuntu20.04"
    with pytest.raises(AttributeError) as excinfo:
    ...
    assert gemma_model_document.training_prepacked_script_uri == "s3://jumpstart-cache-prod-us-west-2/source-directory-tarballs/huggingface/transfer_learning/llm/prepack/v1.1.1/sourcedir.tar.gz"
    assert gemma_model_document.training_prepacked_script_version == "1.1.1"
    assert gemma_model_document.training_script_uri == "s3://jumpstart-cache-prod-us-west-2/source-directory-tarballs/huggingface/transfer_learning/llm/v1.1.1/sourcedir.tar.gz"
    ...
    assert gemma_model_document.training_artifact_uri == "s3://jumpstart-cache-prod-us-west-2/huggingface-training/train-huggingface-llm-gemma-2b-instruct.tar.gz"
    assert gemma_model_document.hyperparameters == [
        ...
        JumpStartHyperparameter({"Name": "lora_alpha", "Type": "int", "Default": 16, "Min": 0, "Scope": "algorithm"}, is_hub_content=True),
        JumpStartHyperparameter({
            "Name": "lora_dropout",
            "Type": "float",
            "Default": 0,
        ...
        JumpStartHyperparameter({"Name": "bits", "Type": "int", "Default": 4, "Scope": "algorithm"}, is_hub_content=True),
        JumpStartHyperparameter({
            "Name": "double_quant",
            "Type": "text",
            "Default": "True",
        ...
        JumpStartHyperparameter({"Name": "max_steps", "Type": "int", "Default": -1, "Scope": "algorithm"}, is_hub_content=True),
        JumpStartHyperparameter({
    ...
    assert np.array_equal(gemma_model_document.supported_training_instance_types, [
        "ml.g5.2xlarge",
        "ml.g5.4xlarge",
        "ml.g5.8xlarge",
        "ml.g5.16xlarge",
    ...
    assert gemma_model_document.default_training_dataset_uri == "s3://jumpstart-cache-prod-us-west-2/training-datasets/oasst_top/train/"
    ...
    assert gemma_model_document.min_studio_sdk_version == "1.0.0"
