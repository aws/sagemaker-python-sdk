...
class JumpStartCuratedHubTest(unittest.TestCase):
    ...
    #     mock_curated_hub_client = Mock()
    #     self._curated_hub_client = mock_curated_hub_client
    ...
    # @patch(
    #     f"{MODULE_PATH}._configure_dependencies"
    # )
    # @patch(
    #     f"{MODULE_PATH}._get_sm_client"
    # )
    ...
    #     self, mock_metadata_map, mock_get_sm_client, mock_configure_deps
    # ):
    #     mock_sm_client = Mock()
    #     mock_sm_client.describe_hub.return_value = {
    #         "S3StorageConfig": {
    ...
    #     self.test_curated_hub = JumpStartCuratedHub(TEST_HUB_NAME, "us-east-1", use_preexisting_hub=True)
