...
class ModelDocumentCreatorTest(unittest.TestCase):
    ...
    @patch("sagemaker.jumpstart.curated_hub.model_document.ModelDocumentCreator._make_hub_dependency_list")
    ...
    def setUp(self, mock_src, mock_dst, mock_hub_dependency_list):
        ...
        mock_hub_dependency_list.return_value = None # mocking dependencies as they're all from the content copy

        self.mock_studio_metadata = {
            self.test_model_id: {
                "dataType": "test_dataType",
                "problemType": "test_problemType"
            }
        }

        self.test_document_creator = ModelDocumentCreator(self.test_region, mock_src, mock_dst, self.mock_studio_metadata)

    # Testing overall workflow

    @patch("sagemaker.jumpstart.curated_hub.model_document.ModelDocumentCreator._dataset_config")
    @patch("sagemaker.jumpstart.curated_hub.model_document.ModelDocumentCreator._make_hub_content_default_training_config")
    @patch("sagemaker.jumpstart.curated_hub.model_document.ModelDocumentCreator._make_hub_content_default_deployment_config")
    @patch("sagemaker.jumpstart.types.JumpStartModelSpecs")
    def test_no_training_removes_fields(self, mock_model_specs, mock_deployment_config, mock_training_config, mock_dataset_config):
    ...
    @patch("sagemaker.jumpstart.curated_hub.model_document.ModelDocumentCreator._make_hub_content_default_deployment_config")
    @patch("sagemaker.jumpstart.types.JumpStartModelSpecs")
    def test_training_supported_adds_capability_and_training_configs(self, mock_model_specs, mock_deployment_config, mock_training_config, mock_dataset_config):
    ...
    @patch("sagemaker.jumpstart.curated_hub.model_document.ModelDocumentCreator._make_hub_content_default_deployment_config")
    @patch("sagemaker.jumpstart.types.JumpStartModelSpecs")
    def test_incremental_training_supported_adds_capability(self, mock_model_specs, mock_deployment_config, mock_training_config, mock_dataset_config):
        mock_model_specs.training_supported = False
    ...
    @patch("sagemaker.jumpstart.curated_hub.model_document.ModelDocumentCreator._make_hub_content_default_deployment_config")
    @patch("sagemaker.jumpstart.types.JumpStartModelSpecs")
    def test_prepack_removes_script_uri(self, mock_model_specs, mock_deployment_config, mock_training_config, mock_dataset_config):
        mock_model_specs.training_supported = False
        mock_model_specs.incremental_training_supported = False
