...
def test_remove_customer_metadata(sagemaker_session):
    ...
    model_package.remove_customer_metadata_properties(customer_metadata_properties_to_remove=customer_metadata_to_remove)
...
def test_add_inference_specification(sagemaker_session):
    ...
    try:
        model_package.add_inference_specification(image_uris=image_uris, name="Inference", containers=containers)
