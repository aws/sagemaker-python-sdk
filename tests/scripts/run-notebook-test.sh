...
./amazon-sagemaker-examples/advanced_functionality/r_bring_your_own/r_bring_your_own.ipynb \
./amazon-sagemaker-examples/advanced_functionality/scikit_bring_your_own/scikit_bring_your_own.ipynb \
...
./amazon-sagemaker-examples/sagemaker-python-sdk/chainer_cifar10/chainer_single_machine_cifar10.ipynb \
./amazon-sagemaker-examples/sagemaker-python-sdk/chainer_cifar10/chainermn_distributed_cifar10.ipynb \
./amazon-sagemaker-examples/sagemaker-python-sdk/chainer_mnist/chainer_mnist_local_mode.ipynb \
...
./amazon-sagemaker-examples/sagemaker-python-sdk/mxnet_mnist/mxnet_mnist_elastic_inference_local.ipynb \
...
./amazon-sagemaker-examples/sagemaker-python-sdk/paddlepaddle_sentiment_analysis_byo_mms/Bring\ Your\ Own\ DL\ Framework\ to\ Amazon\ Sagemaker\ with\ Model\ Server\ for\ Apache\ MXNet\'s\ \(MMS\)\ BYO\ container.ipynb \
...
./amazon-sagemaker-examples/sagemaker-spark/pyspark_mnist/pyspark_mnist_kmeans.ipynb \
