...
def test_upload_data_absolute_file(sagemaker_session):
    ...
    uploaded_file = sagemaker_session.upload_data(data_path, ExtraArgs=AES_ENCRYPTION_ENABLED)
...
def test_upload_data_absolute_dir(sagemaker_session):
    ...
    uploaded_dir = sagemaker_session.upload_data(data_path, ExtraArgs=AES_ENCRYPTION_ENABLED)
