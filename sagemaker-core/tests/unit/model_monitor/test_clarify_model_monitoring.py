...
class TestModelBiasMonitorAdvanced:
    ...
    def test_suggest_baseline_with_all_params(self, mock_session):
        ...
        with patch("sagemaker.core.model_monitor.clarify_model_monitoring.SageMakerClarifyProcessor") as mock_processor_class:
            mock_processor = Mock()
            mock_processor.latest_job = Mock()
            mock_processor_class.return_value = mock_processor
    ...
    @patch("sagemaker.core.s3.S3Uploader.upload_string_as_file_body")
    @patch("sagemaker.core.common_utils.name_from_base")
    def test_create_monitoring_schedule_with_batch_transform(self, mock_name, mock_upload, mock_session):
    ...
    @patch("sagemaker.core.s3.S3Uploader.upload_string_as_file_body")
    @patch("sagemaker.core.common_utils.name_from_base")
    def test_create_monitoring_schedule_with_data_analysis_time(self, mock_name, mock_upload, mock_session):
