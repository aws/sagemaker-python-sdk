...
"""Unit tests for sagemaker.core.modules.constants module."""
from __future__ import absolute_import

import os
from sagemaker.core.modules import constants


class TestModulesConstants:
    """Test modules constants module."""
    ...
    def test_sm_drivers_local_path(self):
        ...
        assert "train/container_drivers" in constants.SM_DRIVERS_LOCAL_PATH
