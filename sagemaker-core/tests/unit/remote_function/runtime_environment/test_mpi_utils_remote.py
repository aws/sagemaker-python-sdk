...
class TestMain:
    ...
    @patch("sagemaker.core.remote_function.runtime_environment.mpi_utils_remote.os.environ", {
    ...
    def test_main_master_node_job_running(self, mock_json_loads, mock_bootstrap_master, mock_start_sshd, mock_parse):
