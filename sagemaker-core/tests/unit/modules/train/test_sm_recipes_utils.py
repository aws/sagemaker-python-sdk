...
class TestSMRecipesUtils:
    ...
    def test_load_base_recipe_from_file(self, mock_unlink, mock_merge, mock_load, mock_copy, mock_isfile):
    ...
    @patch("sagemaker.core.modules.train.sm_recipes.utils.OmegaConf.merge")
    @patch("sagemaker.core.modules.train.sm_recipes.utils.os.unlink")
    def test_load_base_recipe_from_url(self, mock_unlink, mock_merge, mock_load, mock_urlretrieve, mock_isfile):
    ...
    def test_get_args_from_recipe_gpu(self, mock_save, mock_resolve, mock_register, 
                                      mock_configure_gpu, mock_load_recipe, mock_load_cfg):
    ...
    @patch("sagemaker.core.modules.train.sm_recipes.utils._try_resolve_recipe")
    @patch("sagemaker.core.modules.train.sm_recipes.utils.OmegaConf.save")
    def test_get_args_from_recipe_trainium(self, mock_save, mock_resolve, mock_register,
                                           mock_configure_trainium, mock_load_recipe, mock_load_cfg):
    ...
    @patch("sagemaker.core.modules.train.sm_recipes.utils._register_custom_resolvers")
    @patch("sagemaker.core.modules.train.sm_recipes.utils._try_resolve_recipe")
    def test_get_args_from_recipe_unresolvable(self, mock_resolve, mock_register,
                                                mock_configure_gpu, mock_load_recipe, mock_load_cfg):
