...
class TestLocalContainer:
    ...
    def test_train_success(self, mock_rmtree, mock_stream, mock_popen, mock_makedirs, mock_session, basic_channel):
            ...
            with patch.object(_LocalContainer, "_create_config_file_directories"):
                with patch.object(_LocalContainer, "_write_config_files"):
                    with patch.object(_LocalContainer, "_ecr_login_if_needed", return_value=False):
                        with patch.object(_LocalContainer, "_generate_compose_file", return_value={"services": {"algo-1": {"volumes": []}}}):
                            with patch.object(_LocalContainer, "_generate_compose_command", return_value=["docker-compose", "up"]):
                                with patch.object(_LocalContainer, "retrieve_artifacts", return_value="/tmp/model.tar.gz"):
    ...
    @patch("sagemaker.core.modules.local_core.local_container.os.makedirs")
    def test_retrieve_artifacts(self, mock_makedirs, mock_tar, mock_copy, mock_listdir, mock_exists, mock_check_studio, mock_session, basic_channel):
    ...
    def test_create_config_file_directories(self, mock_session, basic_channel):
        ...
        with patch("sagemaker.core.modules.local_core.local_container.os.makedirs") as mock_makedirs:
    ...
    def test_generate_compose_file(self, mock_file, mock_session, basic_channel):
        ...
        result = container._generate_compose_file(
    ...
    def test_create_docker_host(self, mock_session, basic_channel):
        ...
        with patch("sagemaker.core.modules.local_core.local_container._aws_credentials", return_value=["AWS_KEY=value"]):
    ...
    def test_create_docker_host_with_gpu(self, mock_session, basic_channel):
        ...
        with patch("sagemaker.core.modules.local_core.local_container._aws_credentials", return_value=[]):
            result = container._create_docker_host(
                host="algo-1",
                environment={},
                volumes=[]
    ...
    def test_generate_compose_command(self, mock_session, basic_channel):
        ...
        with patch.object(_LocalContainer, "_get_compose_cmd_prefix", return_value=["docker", "compose"]):
    ...
    @patch("sagemaker.core.modules.local_core.local_container.subprocess.Popen")
    def test_ecr_login_if_needed_with_ecr_image(self, mock_popen, mock_check_output, mock_session, basic_channel):
    ...
    @patch("sagemaker.core.modules.local_core.local_container._check_output")
    def test_ecr_login_if_needed_with_local_image(self, mock_check_output, mock_session, basic_channel):
    ...
    def test_get_compose_cmd_prefix_docker_compose_v2(self, mock_check_output, mock_session, basic_channel):
    ...
    def test_get_compose_cmd_prefix_docker_compose_standalone(self, mock_which, mock_check_output, mock_session, basic_channel):
    ...
    @patch("sagemaker.core.modules.local_core.local_container.subprocess.check_output")
    @patch("sagemaker.core.modules.local_core.local_container.shutil.which")
    def test_get_compose_cmd_prefix_not_found(self, mock_which, mock_check_output, mock_session, basic_channel):
    ...
    @patch("sagemaker.core.modules.local_core.local_container.os.makedirs")
    def test_prepare_training_volumes_with_metadata_dir(self, mock_makedirs, mock_session, basic_channel):
        ...
        with patch("sagemaker.core.modules.local_core.local_container.os.path.isdir", return_value=True):
            with patch.object(_LocalContainer, "_get_data_source_local_path", return_value="/tmp/data"):
    ...
    def test_prepare_training_volumes_with_local_training_script(self, mock_session, basic_channel):
        ...
        with patch("sagemaker.core.modules.local_core.local_container.os.makedirs"):
            with patch("sagemaker.core.modules.local_core.local_container.os.path.isdir", return_value=False):
                with patch.object(_LocalContainer, "_get_data_source_local_path", return_value="/tmp/data"):
                    volumes = container._prepare_training_volumes(
                        data_dir="/tmp/test/input/data",
                        input_data_config=[basic_channel],
    ...
    def test_retrieve_artifacts_with_windows_paths(self, mock_session, basic_channel):
        ...
        with patch("sagemaker.core.modules.local_core.local_container.os.makedirs"):
            with patch("sagemaker.core.modules.local_core.local_container.os.listdir", return_value=["file.txt"]):
    ...
    @patch("sagemaker.core.modules.local_core.local_container.check_for_studio")
    def test_generate_compose_file_sets_timeout_env(self, mock_check_studio, mock_session, basic_channel):
    ...
    def test_write_config_files_with_content_type(self, mock_session):
        ...
        with patch("sagemaker.core.modules.local_core.local_container._write_json_file") as mock_write:
            container._write_config_files(
                host="algo-1",
                input_data_config=[channel],
                hyper_parameters={}
