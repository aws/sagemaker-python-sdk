...
class TestSetManifestFileS3Key:
    ...
    def test_set_manifest_file_s3_key_proprietary(self, mock_s3_client, mock_sagemaker_session):
        ...
        with patch.object(cache, "clear") as mock_clear:
            cache.set_manifest_file_s3_key(
                cache._proprietary_manifest_s3_key,
...
class TestIsLocalMetadataMode:
    ...
    def test_is_local_metadata_mode_true(self, mock_s3_client, mock_sagemaker_session, tmp_path):
        ...
        with patch.dict(os.environ, {
            ...
            assert cache._is_local_metadata_mode() is False  # Will be False without correct env vars
...
class TestSelectVersion:
    ...
    def test_select_version_proprietary_wildcard_error(self, mock_s3_client, mock_sagemaker_session):
...
class TestGetManifest:
    ...
    def test_get_manifest_open_weights(self, mock_s3_client, mock_sagemaker_session, sample_manifest):
...
class TestClear:
    ...
    def test_clear(self, mock_s3_client, mock_sagemaker_session):
        ...
        with patch.object(cache._content_cache, "clear") as mock_content_clear:
            with patch.object(cache._open_weight_model_id_manifest_key_cache, "clear") as mock_ow_clear:
                with patch.object(cache._proprietary_model_id_manifest_key_cache, "clear") as mock_prop_clear:
                    cache.clear()
...
class TestGetHubModel:
    ...
    def test_get_hub_model(self, mock_s3_client, mock_sagemaker_session):
        ...
        mock_specs = Mock(spec=JumpStartModelSpecs)
        hub_model_arn = "arn:aws:sagemaker:us-west-2:123456789012:hub-content/my-hub/Model/my-model/1"
...
class TestGetHubModelReference:
    ...
    def test_get_hub_model_reference(self, mock_s3_client, mock_sagemaker_session):
        ...
        mock_specs = Mock(spec=JumpStartModelSpecs)
        hub_model_ref_arn = "arn:aws:sagemaker:us-west-2:123456789012:hub-content/my-hub/ModelReference/my-ref/1"
